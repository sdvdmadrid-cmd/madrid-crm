...
const UI_I18N = {
  en: {
    ...
    estimate: {
      ...
      namePlaceholder: "e.g. Backyard project",
      notesLabel: "Notes",
    ...
    errors: {
      ...
      saveProgress: "Unable to save progress",
    ...
    ai: {
      ...
      inputPlaceholder:
        "e.g. Backyard renovation for a client. Includes paver patio, retaining wall along the back fence, and re-seeding the lawn area...",
    ...
    client: {
      ...
      companyPlaceholder: "e.g. Your company name",
      phoneLabel: "Phone",
  ...
  es: {
    ...
    estimate: {
      ...
      namePlaceholder: "ej. Proyecto de jardin",
      notesLabel: "Notas",
    ...
    ai: {
      ...
      inputPlaceholder:
        "ej. Remodelacion del jardin trasero para un cliente. Incluye patio de adoquines, muro de contencion y resembrado del cesped...",
    ...
    client: {
      ...
      companyPlaceholder: "ej. Nombre de tu empresa",
      phoneLabel: "Telefono",
      phonePlaceholder: "+1 555 000 0000",
      emailLabel: "Email",
      emailPlaceholder: "cliente@ejemplo.com",
  ...
  pl: {
    ...
    estimate: {
      ...
      namePlaceholder: "np. Projekt ogrodu",
      notesLabel: "Notatki",
    ...
    ai: {
      ...
      inputPlaceholder:
        "np. Renowacja ogrodu dla klienta. Obejmuje patio z kostek brukowych, mur oporowy i ponowny wysiew trawy...",
    ...
    client: {
      ...
      companyPlaceholder: "np. Nazwa twojej firmy",
      phoneLabel: "Telefon",
