...
const TEXT = {
  en: {
    ...
    websitePlaceholder: "Ask about your site draft, missing sections, or copyΓÇª",
    ...
    scheduleConfirming: "CreatingΓÇª",
    ...
    estimateDraftReady: "Draft ready ΓÇö review and save in the estimate form.",
    cancel: "Cancel",
  },
  es: {
    open: "IA",
    ...
    estimateDraftReady: "Borrador listo ΓÇö revisa y guarda en el formulario.",
    cancel: "Cancelar",
  },
  pl: {
    open: "AI",
    ...
    websitePlaceholder: "Zapytaj o szkic strony, brakujace sekcje lub tekstyΓÇª",
    ...
    scheduleConfirming: "TworzenieΓÇª",
    ...
    estimateDraftReady: "Szkic gotowy ΓÇö przejrzyj i zapisz w formularzu.",
    cancel: "Anuluj",
  },
};
...
export default function AiBubbleClient({
  ...
  // a time ΓÇö switching modes or asking again clears the previous draft.
  ...
  // a query string parameter ΓÇö no extra global state needed.
                ...
                <ul style={{ margin: "6px 0 6px 14px", padding: 0 }}>
                  {estimateDraft.services.map((svc, idx) => (
                    <li key={idx} style={{ marginBottom: 2 }}>
                      {svc.name} ┬╖ {svc.qty} ├ù ${Number(svc.unitPrice).toFixed(2)} = ${Number(svc.price).toFixed(2)}
                    </li>
                  ))}
                </ul>
              ) : null}
